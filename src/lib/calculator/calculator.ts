 ...
 * @returns 
 */
function calcProfitPerc(target?: number, entry?: number, stopLossPerc?: number, riskReward?: number) {
 ...
 * @returns 
 */
function calcRewardPerc(profitPerc? : number, positionSize? : number, riskReward?: number, risk?: number) {
    if (risk != null && checkPercentage(risk) && riskReward != null) {
        return (risk * riskReward);
    }
    if (profitPerc != null && positionSize != null && checkPercentage(profitPerc) && checkPercentage(positionSize)) {
