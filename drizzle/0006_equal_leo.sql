...
ALTER TABLE "tradeup_positions" RENAME COLUMN "last_updated_at" TO "updated_at";--> statement-breakpoint
...
ALTER TABLE "tradeup_positions" ADD COLUMN "total_fees" numeric(20, 8) NOT NULL;--> statement-breakpoint
...
ALTER TABLE "tradeup_positions" DROP COLUMN IF EXISTS "totalCost";--> statement-breakpoint
